// components/category/EditCategoryModal.jsx
...
const EditCategoryModal = ({ isOpen, onClose, category, token }) => {
  ...
  const { editCategory, isLoading, error, clearCategoryError, successMessage, clearCategorySuccessMessage } = useCategory();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await editCategory(category.id, categoryData, token);
    } catch (err) {
