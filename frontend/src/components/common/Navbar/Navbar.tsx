        ...
        <div className="container px-6 py-4 mx-auto">
          <div className="lg:flex lg:items-center">
            ...
            <div className="flex items-center justify-between">
              <Link href={localePath('/')} className="block lg:hidden" onClick={closeAll}>
                <Image className="w-auto h-7 sm:h-7" src="/logo.png" alt="" width={100} height={28} />
              </Link>
            ...
            <div className="hidden lg:flex flex-1 items-center justify-between">
              <Link href={localePath('/')} onClick={closeAll}>
                <Image className="w-auto h-6 sm:h-9" src="/logo.png" alt="" width={100} height={28} />
              </Link>
            ...
            {isOpen && (
              <div className="lg:hidden fixed top-0 left-0 right-0 bottom-0 z-[99999] flex flex-col bg-white dark:bg-[#1a1a1a] w-full h-screen animate-in fade-in slide-in-from-right duration-300" dir={isRTL ? 'rtl' : 'ltr'}>
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-white to-gray-50 dark:from-[#1a1a1a] dark:to-gray-900 flex-shrink-0">
                  <Link href={localePath('/')} onClick={closeAll} className="flex-shrink-0">
                ...
                <div className="flex-1 flex flex-col gap-2 capitalize scrollbar-hide">
                  ...
                  <div className="dropdown-container">
                    ...
                    {dropdownOpen === 'services' && (
                      <div className={`${isRTL ? 'mr-4 border-r-2' : 'ml-4 border-l-2'} border-[#00437A] mt-2 flex flex-col gap-1 px-3 py-2 bg-gray-50 dark:bg-gray-800/30 rounded-lg`}>
                        ...
                        <Link href="#" onClick={closeAll} className="block px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:text-[#00437A] dark:hover:text-blue-400 transition-colors rounded-lg hover:bg-white dark:hover:bg-gray-800">{t('privatePension')}</Link>
                        <Link href="#" onClick={closeAll} className="block px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:text-[#00437A] dark:hover:text-blue-400 transition-colors rounded-lg hover:bg-white dark:hover:bg-gray-800">{t('familyBusiness')}</Link>
                      </div>
                    )}
                  </div>

                  <Link href={localePath('/blogs')} onClick={closeAll} className="flex items-center gap-3 px-5 py-4 rounded-xl font-semibold text-base text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link href={localePath('/careers')} onClick={closeAll} className="flex items-center gap-3 px-5 py-4 rounded-xl font-semibold text-base text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link href={localePath('/contact')} onClick={closeAll} className="flex items-center gap-3 px-5 py-4 rounded-xl font-semibold text-base text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
