...
export default function Sidebar() {
  ...
  useEffect(() => {
    if (pathname.includes('/dashboard/page-content')) setPageContentOpen(true);
  }, [pathname]);

  useEffect(() => {
    if (
      pathname.includes('/dashboard/funds') ||
      pathname.includes('/dashboard/waiting-approve') ||
      pathname.includes('/dashboard/add-fund') ||
  ...
  useEffect(() => {
    if (pathname.includes('/dashboard/page-content/about')) setAboutOpen(true);
  }, [pathname]);

  useEffect(() => {
    if (pathname.includes('/dashboard/page-content/services')) setServicesOpen(true);
  }, [pathname]);

  useEffect(() => {
    if (pathname.includes('/dashboard/page-content/careers')) setCareersOpen(true);
  }, [pathname]);
  ...
  useEffect(() => {
    if (isAuthenticated && (isAdmin || isManager)) getAllFunds();
  ...
  const subLinkClass = (active: any) =>
    `flex items-center px-2 py-1.5 rounded-base hover:bg-white/20 hover:text-white group transition-all duration-300 text-sm ${active ? 'text-white bg-white/20' : 'text-white/80'
    }`;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <Link href="/dashboard" className="flex ms-2 md:me-24">
                <Image src="/white-logo.png" alt="Alpha Logo" width={80} height={30} className="me-3" />
              </Link>
            </div>
            <div className="flex items-center" >
              <div className="flex items-center ms-3 relative">
                <div  >
                  <button
                    type="button"
                    className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 transition-all duration-300 hover:scale-110 hover:ring-4 hover:ring-white/50"
                    onClick={() =>
                ...
                >
                  <div className="px-4 py-3 border-b border-gray-200" role="none">
                    <div className="flex items-start justify-between flex-col">
                      ...
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-[9px] font-medium mt-1 ${user?.role === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'
                        }`}>
                        {user?.role || 'user'}
                      </span>
                    </div>
          ...
          <ul className="space-y-4 font-medium mt-[60px]">
            ...
            {isAdmin && (
              <>
                {/* Dashboard */}
                <li>
                  <Link href="/dashboard" className="flex items-center px-2 py-1.5 text-white rounded-xl hover:bg-white/20 group transition-all duration-300 transform hover:translate-x-2 w-[95%]">
                    <svg className="w-5 h-5 text-white transition duration-300 group-hover:scale-110 group-hover:text-[#008dff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <li>
                  <button
                    ...
                    className="flex items-center justify-between w-[95%] px-2 py-1.5 text-white rounded-xl hover:bg-white/20 group transition-all duration-300 transform hover:translate-x-2"
                  >
                    <div className="flex items-center">
                      <svg className="shrink-0 w-5 h-5 text-white transition duration-300 group-hover:scale-110 group-hover:text-[#008dff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                      ...
                      <span className="ms-3 text-white whitespace-nowrap">Fund Manager</span>
                    </div>
                    <svg className={`w-4 h-4 text-white transition-transform duration-300 ${fundManagerOpen ? 'rotate-90' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {fundManagerOpen && (
                    <ul className="ms-8 mt-2 space-y-1">
                      {/* All Funds */}
                      <li>
                        <Link href="/dashboard/funds" className={subLinkClass(pathname === '/dashboard/funds' || (pathname.includes('/dashboard/funds') && !pathname.includes('funds-manager')))}>
                          ...
                          <span>All Funds</span>
                          <span className="ml-auto inline-flex items-center justify-center w-4.5 h-4.5 text-xs font-medium text-white bg-white/20 border border-white/30 rounded-full">
                            {Array.isArray(funds) ? funds.length : 0}
                          </span>
                        </Link>
                      </li>

                      {/* Fund Waiting Approve */}
                      <li>
                        <Link href="/dashboard/waiting-approve" className={subLinkClass(pathname.includes('/dashboard/waiting-approve'))}>
                          ...
                          <span>Fund Waiting Approve</span>
                      ...
                      {/* Add Fund */}
                      <li>
                        <Link href="/dashboard/add-fund" className={subLinkClass(pathname.includes('/dashboard/add-fund'))}>
                          <svg className="w-4 h-4 me-2 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <li>
                  ...
                  >
                    <div className="flex items-center">
                      <svg className="shrink-0 w-5 h-5 text-white transition duration-300 group-hover:scale-110 group-hover:text-[#008dff]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                        <path d="M4 6.5C4 5.67157 4.67157 5 5.5 5H18.5C19.3284 5 20 5.67157 20 6.5V8.5C20 9.32843 19.3284 10 18.5 10H5.5C4.67157 10 4 9.32843 4 8.5V6.5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M4 15.5C4 14.6716 4.67157 14 5.5 14H13.5C14.3284 14 15 14.6716 15 15.5V17.5C15 18.3284 14.3284 19 13.5 19H5.5C4.67157 19 4 18.3284 4 17.5V15.5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      <span className="ms-3 text-white whitespace-nowrap">Page Content</span>
                    </div>
                    <svg className={`w-4 h-4 text-white transition-transform duration-300 ${pageContentOpen ? 'rotate-90' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </button>
                  ...
                  {pageContentOpen && (
                    <ul className="ms-8 mt-2 space-y-1">
                      <li>
                        <Link href="/dashboard/page-content/home" className={subLinkClass(pathname.includes('/dashboard/page-content/home'))}>
                      ...
                      {/* About */}
                      <li>
                        <button onClick={() => setAboutOpen(!aboutOpen)} className={`flex items-center px-2 py-1.5 rounded-base hover:bg-white/20 hover:text-white transition-all duration-300 text-sm w-full text-left ${pathname.includes('/dashboard/page-content/about') ? 'text-white bg-white/20' : 'text-white/80'}`}>
                        ...
                        {aboutOpen && (
                          <ul className="ms-8 mt-2 space-y-1">
                            <li><Link href="/dashboard/page-content/about" className={subLinkClass(pathname === '/dashboard/page-content/about')}><span className="ms-3">About Page</span></Link></li>
                            <li><Link href="/dashboard/page-content/about/committee" className={subLinkClass(pathname.includes('/dashboard/page-content/about/committee'))}><span className="ms-3">Committee</span></Link></li>
                            <li><Link href="/dashboard/page-content/about/holdingcompany" className={subLinkClass(pathname.includes('/dashboard/page-content/about/holdingcompany'))}><span className="ms-3">Holding Company</span></Link></li>
                          </ul>
                        )}
                      </li>
                      ...
                      {/* Services */}
                      <li>
                        <button onClick={() => setServicesOpen(!servicesOpen)} className={`flex items-center px-2 py-1.5 rounded-base hover:bg-white/20 hover:text-white transition-all duration-300 text-sm w-full text-left ${pathname.includes('/dashboard/page-content/services') ? 'text-white bg-white/20' : 'text-white/80'}`}>
                      ...
                      {/* Careers */}
                      <li>
                        <button onClick={() => setCareersOpen(!careersOpen)} className={`flex items-center px-2 py-1.5 rounded-base hover:bg-white/20 hover:text-white transition-all duration-300 text-sm w-full text-left ${pathname.includes('/dashboard/page-content/careers') ? 'text-white bg-white/20' : 'text-white/80'}`}>
                        ...
                        {careersOpen && (
                          <ul className="ms-8 mt-2 space-y-1">
                            <li><Link href="/dashboard/page-content/careers" className={subLinkClass(pathname === '/dashboard/page-content/careers')}><span className="ms-3">Careers</span></Link></li>
                            <li><Link href="/dashboard/page-content/careers/applications" className={subLinkClass(pathname.includes('/dashboard/page-content/careers/applications'))}><span className="ms-3">Applications</span></Link></li>
                          </ul>
                        )}
                      </li>
                ...
                {/* Users */}
                <li>
                  <Link href="/dashboard/users" className="flex items-center px-2 py-1.5 text-white rounded-xl hover:bg-white/20 group transition-all duration-300 transform hover:translate-x-2 w-[95%]">
                    <svg className="shrink-0 w-5 h-5 text-white transition duration-300 group-hover:scale-110 group-hover:text-[#008dff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            {isManager && (
              <li>
                <Link href="/dashboard/funds-manager" className="flex items-center px-2 py-1.5 text-white rounded-xl hover:bg-white/20 group transition-all duration-300 transform hover:translate-x-2 w-[95%]">
                  <svg className="shrink-0 w-5 h-5 text-white transition duration-300 group-hover:scale-110 group-hover:text-[#008dff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 13h3.439a.991.991 0 0 1 .908.6 3.978 3.978 0 0 0 7.306 0 .99.99 0 0 1 .908-.6H20M4 13v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-6M4 13l2-9h12l2 9M9 7h6m-7 3h8" />
                  </svg>
                  <span className="flex-1 ms-3 whitespace-nowrap text-white">Funds</span>
                  <span className="inline-flex items-center justify-center w-4.5 h-4.5 ms-2 text-xs font-medium text-white bg-white/20 border border-white/30 rounded-full">
                    {Array.isArray(funds) ? funds.length : 0}
                  </span>
                </Link>
              </li>
            ...
            {isAuthenticated && (
              <li>
                <Link href="" className="flex items-center px-2 py-1.5 text-white rounded-xl hover:bg-white/20 group transition-all duration-300 transform hover:translate-x-2 w-[95%]" onClick={handleLogout}>
