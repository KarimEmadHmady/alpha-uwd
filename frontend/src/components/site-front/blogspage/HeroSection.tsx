...
export default function HeroSection({ data, BASE_URL, lang }: { data: any; BASE_URL: string; lang: string }) {
  ...
  const bgImage = safeData.heroImage
    ? (safeData.heroImage.startsWith('http') ? safeData.heroImage : `${BASE_URL}/${safeData.heroImage}`)
    : '/herosec-careers.png';

  const bgPattern = safeData.backgroundImage
    ? (safeData.backgroundImage.startsWith('http') ? safeData.backgroundImage : `${BASE_URL}/${safeData.backgroundImage}`)
    : '/Group 5.png';

  return (
    <section className="relative h-auto p-3 overflow-hidden bg-[#F2F2F2] dark:bg-[#1a1a1a]" dir={lang === 'ar' ? 'rtl' : 'ltr'}>

      <Image src={bgPattern} alt="Background Pattern" fill
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 pb-0 relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 items-center min-h-[420px]">
          ...
          <div className="space-y-6 relative z-10">
            <div className="inline-flex items-center gap-2 border border-gray-200 dark:border-gray-700 rounded-full px-5 py-2 text-xl text-gray-600 dark:text-gray-400  bg-white dark:bg-gray-800 shadow-lg mb-8">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-800 dark:text-gray-50 leading-tight">
              {safeData.title || 'Blogs'}
            </h1>

            <p className="text-gray-500 dark:text-gray-400 text-base max-w-md leading-relaxed">
              {safeData.subtitle || 'Explore articles, tips, and in-depth analysis written'}
            </p>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  From <span ref={el => { counterRefs.current[3] = el; }}>0+</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-[360px] lg:h-[280px]">
            <div className="absolute top-4 left-0 z-10 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg px-5 py-3 text-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full h-full max-w-md mx-auto">
                <Image src={bgImage} alt="Hero" fill
