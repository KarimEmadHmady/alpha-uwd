    ...
    <div className="max-w-7xl mx-auto px-6 py-6 pb-0 relative z-10">
      <div className="grid lg:grid-cols-2 gap-10 items-center min-h-[420px]">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                {safeData.trustLabel || 'From'} <span ref={el => { counterRefs.current[3] = el; }}>0+</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative h-[360px] lg:h-[280px]">
          ...
          <div className="absolute top-4 left-0 z-10 bg-white dark:bg-[#1a1a1a] border border-gray-100 dark:border-gray-800 rounded-2xl shadow-lg px-5 py-3 text-center">
            <p className="text-2xl font-bold text-gray-800 dark:text-gray-50">
              <span ref={el => { counterRefs.current[0] = el; }}>0</span>
            </p>
            <p className="text-xs text-gray-500 dark:text-gray-400">
              {safeData.totalUsersLabel || 'Total Users'}
            </p>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-full h-full max-w-md mx-auto">
              <Image
                src={safeData.heroImage?.startsWith('http') ? safeData.heroImage : (safeData.heroImage ? `${BASE_URL}/${safeData.heroImage}` : "/herosec-careers.png")}
