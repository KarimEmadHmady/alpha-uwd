...
export default function WhyChooseUsSection({ data, BASE_URL, lang }: WhyChooseUsSectionProps) {
  const safeData = data || {};
        ...
        <div className="relative bg-[#00437A] rounded-3xl overflow-hidden px-8 py-16 text-center">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-5">
            ...
            <div className="inline-flex items-center gap-2 border border-white/30 rounded-full px-4 py-1.5 text-sm text-white/80">
              {safeData.badgeText || 'Why Choose Us'}
            </div>

            <h2 className="text-3xl lg:text-4xl font-bold text-white leading-snug">
              {safeData.title || 'Trusted Expertise To Grow And Protect'}<br />
              {safeData.title ? '' : 'Your Wealth'}
            </h2>

            <p className="text-blue-200 text-sm leading-relaxed">
              {safeData.description || 'Trusted By Thousands Who\'ve Built Smarter, More Secure Financial Futures With Alpha'}
            </p>
            ...
            >
              {safeData.ctaText || 'View All Services'}
