      ...
      <div className="max-w-7xl mx-auto px-6 py-6 pb-0 relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 items-center min-h-[420px]">
          ...
          <div className="space-y-6 relative z-10 ">
            <div className="inline-flex items-center gap-2 border-3 border-[#00437A] dark:border-gray-700 rounded-full px-5 py-2 text-xl text-gray-600 dark:text-gray-400  bg-white dark:bg-gray-800 shadow-lg mb-8 bg-white/60 dark:bg-white/5">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-800 dark:text-gray-50 leading-tight">
              {safeData.title || 'About Us'}<br />
            </h1>
            <p className="text-gray-500 dark:text-gray-400 text-base max-w-md leading-relaxed">
              {safeData.subtitle || 'Reputable asset manager with an impressive track record'}
            </p>
          ...
          <div className="relative h-[360px] lg:h-[280px]">
            ...
            {/* <div className="absolute bottom-28 left-0 z-10 bg-[#00437A] text-white rounded-2xl shadow-xl px-5 py-3 min-w-[140px] opacity-80">
              <p className="text-xs text-blue-200 mb-0.5">Active Users</p>
              <p className="text-2xl font-bold"><span ref={el => { counterRefs.current[1] = el; }}>0</span></p>
              <p className="text-xs text-blue-200">Growth Last Month</p>
            </div> */}

            {/* Floating bottom-right */}
            {/* <div className="absolute bottom-6 right-0 z-10 bg-white dark:bg-[#2a2a2a] border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg dark:shadow-black/40 px-5 py-3 text-center">
              <p className="text-2xl font-bold text-gray-800 dark:text-gray-50">
