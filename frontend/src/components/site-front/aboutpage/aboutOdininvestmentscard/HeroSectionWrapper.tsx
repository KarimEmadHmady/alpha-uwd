...
async function getHoldingCompanyHeroContent(lang: string) {
  try {
...
export default async function HoldingCompanyHeroSectionWrapper({ lang }: { lang: string }) {
  const hero = await getHoldingCompanyHeroContent(lang) ?? FALLBACK;
