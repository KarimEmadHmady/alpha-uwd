...
async function getServicesHeroContent(lang: string) {
  try {
...
export default async function ServicesHeroSectionWrapper({ lang }: { lang: string }) {
  const hero = await getServicesHeroContent(lang) ?? FALLBACK;
