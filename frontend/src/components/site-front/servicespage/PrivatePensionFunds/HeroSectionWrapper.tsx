...
async function getPrivatePensionFundsHeroContent(lang: string) {
  try {
...
export default async function PrivatePensionFundsHeroSectionWrapper({ lang }: { lang: string }) {
  const hero = await getPrivatePensionFundsHeroContent(lang) ?? FALLBACK;
