...
async function getPortfolioManagementHeroContent(lang: string) {
  try {
...
export default async function PortfolioManagementHeroSectionWrapper({ lang }: { lang: string }) {
  const hero = await getPortfolioManagementHeroContent(lang) ?? FALLBACK;
