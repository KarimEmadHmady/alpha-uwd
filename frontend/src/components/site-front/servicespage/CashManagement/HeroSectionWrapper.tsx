...
async function getCashManagementHeroContent(lang: string) {
  try {
...
export default async function CashManagementHeroSectionWrapper({ lang }: { lang: string }) {
  const hero = await getCashManagementHeroContent(lang) ?? FALLBACK;
