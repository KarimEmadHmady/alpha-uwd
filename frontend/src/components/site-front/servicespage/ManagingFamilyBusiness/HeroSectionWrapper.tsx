...
async function getManagingFamilyBusinessHeroContent(lang: string) {
  try {
...
export default async function ManagingFamilyBusinessHeroSectionWrapper({ lang }: { lang: string }) {
  const hero = await getManagingFamilyBusinessHeroContent(lang) ?? FALLBACK;
