    ...
    <section className="py-20 " dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 border border-[#00437A] rounded-full px-5 py-2 text-xl text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-800 shadow-lg ">
            {blogs.badgeText}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
          {BLOGS.map((blog, i) => (
            <Link key={i} href={blog.href} className="group block rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
              ...
              {/* Content */}
              <div className="p-5">
                <div className="flex items-center gap-1.5 text-xs text-[#00437A] mb-2">
