...
├─ package.json
├─ PostMan
│  ├─ category_collection.postman_collection.json
│  ├─ Category_Multilingual.json
│  ├─ FundAPIMultilingual_Testing_Collection.json
│  ├─ fund_collection.postman_collection.json
│  ├─ role_management.postman_collection.json
│  └─ user_collection.postman_collection.json
...
│  │  └─ role.middleware.js
│  ├─ models
│  │  ├─ category-translation.model.js
│  │  ├─ category.model.js
│  │  ├─ document.model.js
│  │  ├─ entity.model.js
│  │  ├─ fund-manager.model.js
│  │  ├─ fund.model.js
│  │  ├─ fund_translation.model.js
│  │  └─ user.model.js
│  ├─ routes
│  │  ├─ category.routes.js
│  │  ├─ document.routes.js
│  │  ├─ entity.routes.js
│  │  ├─ fund-manager.routes.js
│  │  ├─ fund.routes.js
│  │  └─ user.routes.js
│  ├─ services
│  │  ├─ category.service.js
...
└─ uploads
   ├─ avatars
   │  ├─ avatar-1763385925860.png
   │  ├─ avatar-1763385927159.png
   │  └─ avatar-1764240486881.png
   ├─ documents
   │  └─ document-1763297237744.pdf
   ├─ entities
   │  └─ entity-1763297551658.jpeg
   ├─ image-1762333833788.jpeg
   ├─ image-1762333881828.jpeg
   ├─ image-1762335078086.jpeg
   ├─ image-1762335170924.jpeg
   ├─ image-1762335173186.jpeg
   ├─ image-1762335175179.jpeg
   ├─ image-1762335176992.jpeg
   ├─ image-1763281281465.jpeg
   ├─ image-1763389555517.jpeg
   ├─ image-1763389555536.jpeg
   ├─ image-1763391103584.jpeg
   ├─ image-1763391103603.jpeg
   └─ managers
      └─ manager-1763297939412.jpeg
...
│  ├─ documents
│  ├─ entities
│  ├─ image-1765453590696.jpeg
│  ├─ image-1765453590706.jpeg
│  └─ managers
└─ x.zip
